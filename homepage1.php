...
<div class="row text-center">
          <div class="col-md-4">
            ...
            <p class="text-muted">If you have excess food donate it and improve a life.</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
           ...
           <a href="volunteerlogin.html"> <img src="3-512.png" class="img-circle" alt="Cinque Terre" width="50px" height="50px" ></a>
            ...
            <p class="text-muted">Become a volunteer and help us in this noble cause of feeding the poor and preventing the wastage of food.</p>
          </div>
          <div class="col-md-4">
            <span class="fa-stack fa-4x">
              <i class="fa fa-circle fa-stack-2x text-primary"></i>
           ...
           <a href="adminlogin.html"> <img src="key-512.png" class="img-circle" alt="Cinque Terre" width="50px" height="50px"></a>
            ...
            <p class="text-muted">Admin has all access privilages.</p>
          </div>
      ...
      <ul class="timeline">
        <li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
                We started in 2012 with the sole belief that there is enough food to feed everyone, back then we had only 5 members and a few volunteers who were able to deliver 100+ meals.
              </p>
            </div>
          </div>
          <div class="line"></div>
        ...
        <li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
                We grew over the years, more and more people joined us and we were able to help alot of poor people.
              </p>
            </div>
          </div>
          <div class="line"></div>
        ...
        <li>
          ...
          <div class="timeline-panel">
            ...
            <div class="timeline-body">
              <p class="text-muted">
                Today we are a non-profit with more than 80 volunteers working with us and with the response we've had from the people, the number of meals provided has gone from 100 to 25000+ meals to the needy people.
              </p>
            </div>
          </div>
...
<section class="team-section text-center my-5">
  ...
  <!-- Section description -->
  <p class="grey-text w-responsive mx-auto mb-5">These are our young founders who had this innovative idea of helping needy people.</p>
  ...
  <div class="row text-center">
    ...
    <div class="col-md-4 mb-md-0 mb-5">
      <div class="avatar mx-auto">
        <img src="#" class="rounded z-depth-1-half" alt="Sample avatar" width="200px" height="150px">
      </div>
